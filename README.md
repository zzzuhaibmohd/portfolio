# Zuhaib Mohammed — Smart Contract Engineer • Security Researcher
...
I’m an **Independent Smart Contract Engineer & Security Researcher** with hands-on experience across **60+ production-grade codebases** (development & security).

I specialize in designing **secure-by-architecture smart contracts** and conducting **deep, adversarial protocol audits** across EVM and Solana ecosystems.
...
- ⚙️ DeFi Protocols (AMMs, Perpetual DEXs, Lending/Borrowing)
- 🕹️ Web3 Gaming, DAOs & Launchpads
- 🌉 Cross-Chain & Omnichain Infrastructure
- 💧 Liquid Staking Platforms
- 🧩 Escrow, Merkle Airdrops, Bonding Curves, Vesting, Custom Tokenomics
...
- 🏛️ [The House Protocol – Zero-Liquidation Lending](https://github.com/33Audits/inverter-contracts/tree/feat/house-protocol-release)
- 💰 [Funding Pot – Tier-based Fundraising Module](https://github.com/33Audits/inverter-contracts/tree/funding-pot-dev)
- 🪙 [ETH-Backed Stablecoin (Foundry)](https://github.com/zzzuhaibmohd/stable_coin_foundry)
...
- 📈 [Bonding Curve ERC20](https://github.com/zzzuhaibmohd/Bonding-Curve-Token)
- 🏦 [ERC4626 Vault Implementation](https://github.com/zzzuhaibmohd/erc4626Vault)
- 🗳️ [Vote dApp – Governance & Voting System](https://github.com/zzzuhaibmohd/vote_dapp)
- 🦀 [Solana Course – Rust & Anchor Programs](https://github.com/zzzuhaibmohd/solana-course)
- 🔮 [ProphetRouterV1 (Verified on Etherscan)](https://etherscan.io/address/0x6a153cdf5cc58f47c17d6a6b0187c25c86d1acfd)
